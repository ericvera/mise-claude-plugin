...
Verify with `node docs/v3-research/tools/check-line-evidence.mjs <path to this checkout>` from that branch's checkout.
...
| skills/next/SKILL.md                       | A scope past 20 files — diff files,                                                                   | O-10, E-007, E-073, D-49                           |
...
| skills/next/flow.md                        | Log as you go: `log .mise '<json>'` after                                                             | O-09, D-07, D-25, D-36, D-45                       |
...
| skills/next/flow.md                        | Skip when: the work fits one implementer's context                                                    | O-03, O-13, D-38, D-43                             |
...
| skills/next/flow.md                        | `mark .mise spec done`.                                                                               | E-073                                              |
| skills/next/flow.md                        | Skip when: the spec step was skipped.                                                                 | O-13, O-04, D-43                                   |
| skills/next/flow.md                        | Spawn one `critic` per round over `spec.md`, and                                                      | O-04, D-08, D-27, D-37                             |
| skills/next/flow.md                        | Run the config's `Check` and `Unit tests` once                                                        | E-074, E-058, D-48                                 |
...
| skills/next/flow.md                        | After the last task, `reviewer` batches over the                                                      | O-10, E-019, E-018, E-076, E-073, D-34, D-47, D-48 |
...
| skills/next/flow.md                        | **point** → batch it with the other point                                                             | O-12, E-054, D-18, D-44                            |
| skills/next/flow.md                        | **pattern** ("everywhere", "all instances") → list every instance                                     | O-12, D-44                                         |
...
| skills/next/stages/setup.md                | Then list the reference's optional sections by name,                                                  | O-07, E-064, E-068, D-23, D-28                     |
...
| skills/next/roles/reviewer.md              | You are a fresh-context reviewer: you report defects                                                  | O-10, E-018, E-073, D-29, D-34, D-47               |
| skills/next/roles/reviewer.md              | Read the scope, then the work itself: `git`                                                           | O-10, E-020, E-073, D-49                           |
...
| skills/next/roles/adherence.md             | Walk your batch **file by file**, in order                                                            | O-15, D-12, E-073, D-49                            |
...
| skills/next/references/config-reference.md | Setup's reference for `.claude/mise-config.md`. The file holds values                                 | O-07, E-064, D-30                                  |
...
| skills/retro/SKILL.md                      | Group the `finding`, `feedback`, `stop`, `skip` and `gate`                                            | O-09, O-02, D-42                                   |
