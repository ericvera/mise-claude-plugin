...
| skills/next/SKILL.md                       | `in_flight` false with no description → follow the                                                             | D-01 (M08)                  |
...
| skills/next/SKILL.md                       | Stop only at: the goals approval, the review                                                                   | E-006, E-051, O-12          |
| skills/next/flow.md                        | Ten steps, in order. Answer every **Skip when**                                                                | O-13, D-02                  |
| skills/next/flow.md                        | Log as you go: `log <mise-dir> '<json>'` after                                                                 | O-09, D-07                  |
...
| skills/next/flow.md                        | `## Task index` — one row per task:                                                                            | O-03, O-13, O-04            |
| skills/next/flow.md                        | Write one file per task at `<mise-dir>/tasks/NN_MM_<slug>.md`, each                                            | O-08                        |
...
| skills/next/flow.md                        | **Background** — what prior tasks produced, by file                                                            | O-08                        |
| skills/next/flow.md                        | **Guides** — every config Skills & guides entry                                                                | O-08                        |
| skills/next/flow.md                        | **Implementation details**, **Gotchas**, and **Verification** — the tests                                      | O-08                        |
| skills/next/flow.md                        | Every task must end green on its own:                                                                          | D-01 (M45)                  |
| skills/next/flow.md                        | More than 8 tasks → also write `<mise-dir>/requirements.md`:                                                   | O-03                        |
| skills/next/flow.md                        | `mark <mise-dir> spec done`, commit.                                                                           | E-073                       |
| skills/next/flow.md                        | Skip when: the spec step was skipped **and**                                                                   | O-13, O-04                  |
| skills/next/flow.md                        | Spawn one `critic` per round over `spec.md` (plus                                                              | O-04, D-08                  |
| skills/next/flow.md                        | Run the config's `Check` and `Unit tests` once                                                                 | E-074, E-058                |
| skills/next/flow.md                        | Spawn an `implementer` on the task file, with                                                                  | E-074, E-002                |
| skills/next/flow.md                        | Review: the task index spans 3 or more                                                                         | O-10, E-019, E-073          |
| skills/next/flow.md                        | Blocking findings → one fix round through an                                                                   | E-018, E-076, E-073         |
| skills/next/flow.md                        | `git mv` the task file into `<mise-dir>/tasks/done/` and                                                       | E-073                       |
| skills/next/flow.md                        | `progress.md` carries one entry per task, at most                                                              | E-037, E-038, O-08          |
...
| skills/next/flow.md                        | Spawn one `sweep` subagent over the branch diff                                                                | O-01, E-073                 |
| skills/next/flow.md                        | Write `<mise-dir>/review.md`: one line per task — what                                                         | O-01, O-12, E-051, E-073    |
| skills/next/flow.md                        | Handle each item by what it changes, and                                                                       | O-09, O-12                  |
| skills/next/flow.md                        | **point** → batch it with the other point                                                                      | O-12, E-054                 |
| skills/next/flow.md                        | **pattern** ("everywhere", "all instances") → list every instance                                              | O-12                        |
| skills/next/flow.md                        | **decision** → an amendment (below), then the new                                                              | O-11, D-09, O-12            |
...
| skills/next/flow.md                        | Run once, in order: the config's `Build` when                                                                  | O-06, E-066, E-023          |
| skills/next/flow.md                        | A failure gets one repair through an implementer                                                               | O-06, D-10                  |
| skills/next/flow.md                        | `log {"event":"close","codeLines":…,"artifactLines":…}`, copy `<mise-dir>/ledger.jsonl` to the config's Ledger | D-07, O-12, D-01 (M27, M61) |
| skills/next/flow.md                        | An owner statement that changes a decision already                                                             | O-11, D-09                  |
| skills/next/flow.md                        | Then `amend <mise-dir> "<what changed>"` and re-answer the                                                     | O-11, D-09                  |
...
| skills/next/stages/setup.md                | Ask in SKILL.md's question format, suggesting a value                                                          | O-07, E-050                 |
| skills/next/stages/setup.md                | Mise directory — suggest `.mise/`.                                                                             | O-07                        |
| skills/next/stages/setup.md                | Branch convention — infer from `git branch --sort=-committerdate`,                                             | O-07, E-081                 |
| skills/next/stages/setup.md                | Quality commands — Format, Check, Unit tests; then                                                             | O-07, E-066                 |
| skills/next/stages/setup.md                | Ship — `pr`, `merge` (ask the style: squash,                                                                   | D-01 (M27)                  |
| skills/next/stages/setup.md                | Then list the optional sections by name —                                                                      | O-07, E-064, E-068          |
| skills/next/stages/setup.md                | Write the file with the sections filled and                                                                    | O-07, E-064                 |
| skills/next/stages/setup.md                | Then ensure `CLAUDE.md` carries this line, with the                                                            | E-080, D-01 (M28)           |
...
| skills/next/roles/implementer.md           | Read the mise config (quality commands, Skills &                                                               | O-08, E-065, E-037          |
...
| skills/next/roles/implementer.md           | Verify, in order: `Format`, `Check`, then the tests                                                            | E-066, E-070, O-08          |
| skills/next/roles/implementer.md           | Fix and re-run until green. Once one command                                                                   | E-074                       |
| skills/next/roles/implementer.md           | Read your own `git diff` for task requirements                                                                 | E-046, E-039                |
| skills/next/roles/implementer.md           | Append to the progress log, creating it with                                                                   | E-037, E-038                |
| skills/next/roles/implementer.md           | Commit the work and the log entry together,                                                                    | E-073                       |
| skills/next/roles/implementer.md           | Report in at most 10 lines: the commit                                                                         | E-051, E-002                |
| skills/next/roles/implementer.md           | Do not touch files outside the task's scope                                                                    | E-074, D-01 (M45)           |
| skills/next/roles/reviewer.md              | You are a fresh-context reviewer: you report defects                                                           | O-10, E-018, E-073          |
...
| skills/next/roles/reviewer.md              | missing test coverage that no Test exception cited                                                             | E-070, E-040                |
...
| skills/next/roles/critic.md                | You are a fresh-context critic: you review the                                                                 | O-04, D-08, E-073           |
...
| skills/next/roles/adherence.md             | Append to your family's section of `<mise-dir>/adherence.md` one                                               | O-15, E-051, E-073          |
| skills/next/roles/adherence.md             | Report the counts only: files read, files flagged,                                                             | O-15, E-051                 |
| skills/next/roles/sweep.md                 | You are a fresh-context subagent running one sweep                                                             | O-01, E-073                 |
| skills/next/roles/sweep.md                 | Check two things:                                                                                              | O-01                        |
| skills/next/roles/sweep.md                 | **Retirements.** Everything the goals or the spec say                                                          | O-01                        |
| skills/next/roles/sweep.md                 | **Stale instructions.** Instruction and config files the diff                                                  | O-01, E-073                 |
| skills/next/roles/sweep.md                 | Return fix items as `<file>:<line or section> —`                                                               | O-01, E-051                 |
| skills/next/roles/explore.md               | You are a fresh-context, read-only subagent answering one                                                      | E-061, O-03                 |
| skills/next/roles/explore.md               | Answer that question and nothing near it. Return                                                               | E-061                       |
| skills/next/roles/explore.md               | At most 15 lines. Quote code only where                                                                        | E-051, E-061                |
| skills/next/references/config-reference.md | Setup's reference for `.claude/mise-config.md`, never copied into a                                            | O-07, E-064                 |
| skills/next/references/config-reference.md | Required:                                                                                                      | O-07, E-064                 |
| skills/next/references/config-reference.md | **Mise directory** — where in-flight work lives (suggest                                                       | O-07, E-073                 |
| skills/next/references/config-reference.md | **Branch convention** — the branch-name patterns, `<slug>` standing                                            | O-07, E-081                 |
| skills/next/references/config-reference.md | **Ship** — `pr`, `merge (squash \| merge commit`                                                               | D-01 (M27)                  |
| skills/next/references/config-reference.md | **Quality commands** — Format, Check (lint and typecheck),                                                     | O-07, O-06, E-066           |
| skills/next/references/config-reference.md | Optional — omit a section that does not                                                                        | E-064, E-065                |
| skills/next/references/config-reference.md | **Mock conditions** — bulleted conditions deciding whether the                                                 | E-078, E-052                |
| skills/next/references/config-reference.md | **Mock guidance** — product name, UI code root,                                                                | E-078                       |
| skills/next/references/config-reference.md | **Test exceptions** — bulleted `condition — alternative verification`                                          | E-070, E-040                |
...
| skills/next/references/config-reference.md | **Ledger** — where run ledgers are kept after                                                                  | D-07, O-09                  |
| skills/next/references/config-reference.md | **Backlog** — freeform instructions for fetching the top                                                       | D-01 (M24)                  |
| skills/next/references/config-reference.md | **Review notes** — freeform instructions for reading the                                                       | O-12, E-054                 |
| skills/retro/SKILL.md                      | Run `node ${CLAUDE_SKILL_DIR}/../next/scripts/state.ts tally <dir>…` over the Ledger                           | O-14, D-11, O-02, O-09      |
